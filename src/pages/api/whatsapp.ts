...
export const GET: APIRoute = ({ request }) => {
  ...
  const number = import.meta.env.WHATSAPP_NUMBER || '5217774939562';
  const message = encodeURIComponent('Hola, quiero solicitar un diagnóstico express gratuito. Mi empresa es');
